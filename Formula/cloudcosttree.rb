class Cloudcosttree < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/rulssss/cloudcosttree/releases/download/v0.1.47/cloudcosttree-darwin-arm64"
      sha256 "d5747744db1e6d5236ab9a9efc1b9a0e59e881a6565de0e30d03bf32e3b336fd"
    else
      url "https://github.com/rulssss/cloudcosttree/releases/download/v0.1.47/cloudcosttree-darwin-amd64"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/rulssss/cloudcosttree/releases/download/v0.1.47/cloudcosttree-linux-arm64"
      sha256 "2c0c47b7c56ce8af068b19beae2860aa89dc68ed0d83b81bdb602f4fdb3783e8"
    else
      url "https://github.com/rulssss/cloudcosttree/releases/download/v0.1.47/cloudcosttree-linux-amd64"
  ...
  resource "prices" do
    url "https://github.com/rulssss/cloudcosttree/releases/download/v0.1.47/prices.json"
